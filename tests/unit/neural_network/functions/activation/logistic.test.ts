...
describe('Logistic Activation', () => {
    ...
    test('Logistic derive function - negative input', () => {
        const logistic = new Logistic();
        const input = [-1, -2, -3];
        const expected = [0.19661193324148185, 0.1049935854035065, 0.04517665973091214];
        expect(logistic.derive(input)).toEqual(expected);
    });
    ...
    test('Logistic derive function - mixed input', () => {
        const logistic = new Logistic();
        const input = [1, -2, 3];
        const expected = [0.19661193324148185, 0.1049935854035065, 0.045176659730912];
        expect(logistic.derive(input)).toEqual(expected);
    });
});
